  ...
  return (
    <div className="space-y-16 pb-20 bg-grid-pattern relative">
      ...
      <section className="relative overflow-hidden pt-16 pb-20 lg:pt-24 lg:pb-28">
        ...
        <div className="absolute top-1/4 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[700px] h-[400px] bg-indigo-600/15 blur-[140px] rounded-full pointer-events-none animate-pulse-glow" />
        <div className="absolute top-1/3 right-10 w-[350px] h-[350px] bg-purple-600/12 blur-[120px] rounded-full pointer-events-none" />
        ...
        <div className="max-w-5xl mx-auto px-4 sm:px-6 lg:px-8 text-center relative z-10 space-y-6">
          ...
          <p className="text-sm sm:text-base text-slate-400 max-w-2xl mx-auto leading-relaxed font-normal">
            Not just a generic chatbot. ShopPilot AI actively parses your hardware intent, executes 5-dimension fit scoring, protects merchant margins, and auto-recovers checkout friction.
          </p>
          ...
          <div className="max-w-2xl mx-auto mt-8">
            <form onSubmit={handleSearchSubmit} className="relative group">
              ...
              <div className="relative flex items-center bg-[#0C1220]/95 border border-slate-700/80 rounded-2xl p-2 shadow-2xl backdrop-blur-xl group-focus-within:border-indigo-500 transition-colors">
                ...
                <button
                  type="submit"
                  className="px-6 py-3 rounded-xl bg-gradient-to-r from-indigo-600 via-purple-600 to-pink-600 hover:from-indigo-500 hover:to-pink-500 text-white text-xs font-bold flex items-center gap-1.5 transition-all shadow-lg shadow-indigo-600/30 shrink-0 hover:scale-[1.02] active:scale-[0.98]"
                >
            ...
            <div className="flex flex-wrap items-center justify-center gap-2 mt-4 text-xs">
              ...
              {suggestedQueries.map((query, idx) => (
                <button
                  ...
                  className="px-3 py-1 rounded-xl bg-slate-900/80 hover:bg-slate-800 border border-slate-800 hover:border-slate-700 text-slate-300 hover:text-white transition-all text-[11px] hover:-translate-y-0.5"
                >
                  {query}
                </button>
              ))}
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 p-6 sm:p-8 rounded-3xl bg-slate-900/70 border border-slate-800/80 backdrop-blur-xl shadow-2xl">
          <div className="text-center space-y-1 p-2">
            <p className="text-2xl sm:text-3xl font-black text-white tracking-tight">₹6.3Cr+</p>
            <p className="text-xs text-slate-400 font-medium">Total Settled Revenue</p>
          </div>
          <div className="text-center space-y-1 p-2 border-l border-slate-800/80">
            <p className="text-2xl sm:text-3xl font-black text-indigo-400 tracking-tight">97.2%</p>
            <p className="text-xs text-slate-400 font-medium">Recommendation Fit Accuracy</p>
          </div>
          <div className="text-center space-y-1 p-2 border-l border-slate-800/80">
            <p className="text-2xl sm:text-3xl font-black text-emerald-400 tracking-tight">₹50.7L+</p>
            <p className="text-xs text-slate-400 font-medium">Autonomous Recovered Revenue</p>
          </div>
          <div className="text-center space-y-1 p-2 border-l border-slate-800/80">
            <p className="text-2xl sm:text-3xl font-black text-purple-400 tracking-tight">0%</p>
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-6">
        ...
        {loading ? (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
            {[1, 2, 3].map((n) => (
              <div key={n} className="h-84 rounded-3xl bg-slate-900/60 border border-slate-800 animate-pulse" />
            ))}
          </div>
        ) : (
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
              ...
              >
                <div className="space-y-4">
                  ...
                  <div className="relative aspect-video rounded-2xl overflow-hidden bg-slate-950 border border-white/5">
                    ...
                    <span className="absolute top-3 left-3 px-2.5 py-1 rounded-lg text-[10px] font-bold bg-slate-950/80 text-indigo-300 backdrop-blur-md border border-slate-700/60">
                      {product.category}
                    </span>
                    <span className="absolute top-3 right-3 px-2 py-1 rounded-lg text-[10px] font-bold bg-amber-500/20 text-amber-300 border border-amber-500/40 flex items-center gap-1 backdrop-blur-md">
                ...
                <div className="pt-4 mt-4 border-t border-slate-800/80 flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    ...
                    <button
                      ...
                      className="p-2 rounded-xl bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-500 hover:to-purple-500 text-white transition-all shadow-md shadow-indigo-600/30 hover:scale-105 active:scale-95"
                      title="Add to Cart"
                    >
      ...
      <section className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-8">
        <div className="p-8 sm:p-12 rounded-3xl bg-gradient-to-b from-slate-900/90 to-slate-950 border border-slate-800/80 relative overflow-hidden space-y-10 shadow-2xl">
          <div className="absolute top-0 right-0 w-96 h-96 bg-purple-600/10 blur-[120px] pointer-events-none" />

          <div className="text-center space-y-3 max-w-2xl mx-auto">
            <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-widest px-3 py-1 rounded-full bg-indigo-500/10 border border-indigo-500/30">
            ...
            <p className="text-xs text-slate-400 leading-relaxed">
              Unlike static chatbots, ShopPilot AI orchestrates an end-to-end cognitive feedback loop that grounds every decision in real transaction data.
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 relative">
            {[
              ...
              return (
                <div 
                  key={idx} 
                  className="p-6 rounded-2xl bg-slate-950/60 border border-slate-800/80 space-y-3 hover:border-indigo-500/40 transition-all duration-300 group hover:-translate-y-1 shadow-lg"
                >
                  <div className="flex items-center justify-between">
                    ...
                    <span className="text-[10px] font-bold text-indigo-400 uppercase tracking-wider">{item.step}</span>
                  </div>
