...
export default function AuthModal() {
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-slate-950/80 backdrop-blur-md">
      <div className="relative w-full max-w-md rounded-3xl glass-panel border border-slate-700/80 p-6 sm:p-8 space-y-6 shadow-2xl relative overflow-hidden">
        ...
        <div className="flex items-center justify-between relative">
          <div className="flex items-center gap-2.5">
            ...
            <div>
              <h3 className="text-base font-black text-white tracking-tight">ShopPilot AI Authentication</h3>
              <p className="text-[11px] text-slate-400">Secure access to Customer Store or Merchant Engine</p>
            </div>
          </div>
        ...
        <div className="p-3.5 rounded-2xl bg-slate-950/80 border border-slate-800/90 space-y-2">
          <div className="flex items-center justify-between text-[10px] text-slate-400 uppercase tracking-wider font-bold">
            ...
            <span className="text-emerald-400 flex items-center gap-1">
              <span className="w-1.5 h-1.5 rounded-full bg-emerald-400 animate-radar" /> 1-Click Ready
            </span>
          </div>
          ...
          <div className="grid grid-cols-2 gap-2">
            <button
              ...
              className="p-2.5 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-indigo-500/50 text-left transition-all group"
            >
